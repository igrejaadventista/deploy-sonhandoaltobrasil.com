...
try {
	...
	$mail->IsSMTP();
	$mail->SMTPDebug = 4;
	$mail->Port = 465; //Indica a porta de conexão 
	$mail->Host = 'mail.formulario.email';//Endereço do Host do SMTP 
	$mail->SMTPAuth = true; //define se haverá ou não autenticação 
	$mail->Username = 'sonhandoalto@formulario.email'; //Login de autenticação do SMTP
	$mail->Password = 'S0nh@ndoAlt0'; //Senha de autenticação do SMTP
